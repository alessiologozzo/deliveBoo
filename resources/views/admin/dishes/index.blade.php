        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4 mb-5 mt-3">
            <div class="d-flex">
                <div class="input-group">
                    <input type="text" class="form-control shadow bg-body-tertiary rounded" placeholder="Search your Dish"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                    <input class="btn btn-light text-dark shadow bg-body-tertiary rounded ms-2" type="submit"
                        value="Cerca">
                </div>
                <div class="ms-2">
                    <a class="btn btn-light text-dark shadow bg-body-tertiary rounded" href="{{ route('dishes.create') }}"
                        role="button">+</a>
                </div>
            </div>
        </div>
